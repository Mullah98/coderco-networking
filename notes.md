...
- Components: Name servers (authoritative/recursive), zone files, resource records (A, AAAA, CNAME, MX, TXT).
...
- **Types:** Static (manual) vs Dynamic (protocol-based).

- **Protocols:** OSPF (internal, shortest path), BGP (inter-network, policy-based).

---

## Subnetting & CIDR

- Splits network into smaller segments.

- CIDR: /n = network bits.

- Example: 192.168.1.0/26 → Network: 192.168.1.0, Broadcast: 192.168.1.63, Usable IPs: 192.168.1.1–62.
